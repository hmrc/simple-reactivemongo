...
object AppDependencies {
  ...
  val compile = DependenciesSeq(
    ...
    "com.typesafe.play"      %% "play"                    % playVersion crossPlay Play26,
    "com.typesafe.play"      %% "play-guice"              % playVersion crossPlay Play26
  )
  ...
  val test = DependenciesSeq(
    ...
    "com.typesafe.play"      %% "play-test"          % playVersion % Test crossPlay Play26,
