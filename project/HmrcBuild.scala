...
object Dependencies {
  ...
  object Compile {
    val reactiveMongoJson = "uk.gov.hmrc" %% "reactivemongo-json" % "3.0.0"
    ...
    val reactiveMongo0 = "uk.gov.hmrc" %% "reactivemongo" % "0.12.0"
    val reactiveMongo1 = "uk.gov.hmrc" %% "reactivemongo-bson" % "0.11.8" force()
    val reactiveMongo2 = "uk.gov.hmrc" %% "reactivemongo-bson-macros" % "0.11.8" force()
