...
trait BSONObjectIdFormats {
  ...
  implicit val objectIdRead: Reads[BSONObjectID] = Reads[BSONObjectID] { json: JsValue =>
  ...
  implicit val objectIdFormats: Format[BSONObjectID] = Format(
    BSONObjectIdFormats.objectIdRead,
    BSONObjectIdFormats.objectIdWrite
  )
}
